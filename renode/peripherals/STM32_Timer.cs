...
namespace Antmicro.Renode.Peripherals.Timers
{
    ...
    public class STM32_Timer_Custom : LimitTimer, IDoubleWordPeripheral, INumberedGPIOOutput, IPeripheralRegister<IGPIOReceiver, NumberRegistrationPoint<int>>, IPeripheralRegister<IGPIOReceiver, NullRegistrationPoint>
    {
        public STM32_Timer_Custom(IMachine machine, long frequency, uint initialLimit) : base(machine.ClockSource, frequency, limit: initialLimit,  direction: Direction.Ascending, enabled: false, autoUpdate: false)
        {
            ...
            LimitReached += delegate
            {
                ...
                enableRequested = false; // TODO(jon): HAL delay impl is blocked on CEN being cleared
                this.Log(LogLevel.Noisy, "Limit reached autoReloadValue = {0}", autoReloadValue);
